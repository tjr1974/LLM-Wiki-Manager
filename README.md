...
| Pipeline "meta" correctness or drift | **`tests/test_pipeline_step_order.py`**, **`tests/test_make_wiki_all_recipe.py`**, **`tests/test_karpathy_bridge_docs.py`**, **`tests/test_githooks_wiring.py`**, **`tests/conftest.py`**, **`tests/test_makeflags_inheritance.py`**, **`schema/human-wiki-automation-boundary.md`**, **`.github/ISSUE_TEMPLATE/wiki-toolchain.md`** |
